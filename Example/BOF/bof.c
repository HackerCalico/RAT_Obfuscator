    ...
    if (hFind != INVALID_HANDLE_VALUE) {
        ...
        do {
            if (*findData.cFileName != '.') {
                ...
                MSVCRT$sprintf_s(*pOutputData + MSVCRT$strlen(*pOutputData), 330, "\n%d,%s,%llu,%04d.%02d.%02d %02d:%02d:%02d", (findData.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY) ? 1 : 0, findData.cFileName, ((ULONGLONG)findData.nFileSizeHigh << 32) | findData.nFileSizeLow, systemTime.wYear, systemTime.wMonth, systemTime.wDay, systemTime.wHour, systemTime.wMinute, systemTime.wSecond);
